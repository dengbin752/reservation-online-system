...
import type { AuthResponse, PaginatedResponse, Reservation, Table, User } from "../types";
...
export interface IReservationService {
    ...
    getReservations(filters: any, pagination: any): Promise<PaginatedResponse<Reservation>>;
    ...
    getAvailableTables(date: Date, time: string, partySize: number): Promise<Table[]>;
